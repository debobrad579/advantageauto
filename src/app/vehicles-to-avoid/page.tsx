...
export const metadata: Metadata = {
  title: "Vehicles to Avoid",
  description:
    "We have some vehicles that we find are not reliable enough, are in need of constant repairs, or have premature major drive train failures.",
}
      ...
      <div className="column-container">
        ...
        <ul>
          ...
          <li>
            ...
            emissions systems, higher cost of fuel in the winter and general
            cold winter issues do not justify the higher purchase prices and
            slight better fuel economy over gas engines. If you want a true
            diesel, buy something pre 2002 if you can find something worthy of
            rebuilding and maintaining.
          </li>
          <li>
            Any vehicle with a CVT transmission if you are going to tow with it.
            While CVT's have received bad press, we have many that have gone
            over 240,000 kms with proper maintenance.
          </li>
          <li>
